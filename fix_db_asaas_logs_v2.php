<?php
/**
 * Script de Correção Automática - Tabela asaas_logs (VERSÃO 2 - SIMPLIFICADA)
 * 
 ...
 * Data: 2026-01-15
 * Versão: 2.0 (Conexão direta sem config.php)
 */
...
<head>
    ...
    <title>Correção Banco de Dados - asaas_logs v2</title>
    <style>
        ...
        .step-title { font-weight: bold; color: #4CAF50; margin-bottom: 10px; font-size: 16px; }
        code { background: #f8f9fa; padding: 2px 6px; border-radius: 3px; font-family: monospace; }
    </style>
</head>
<body>
    <div class='container'>
        <h1>🔧 Correção: Tabela asaas_logs (v2)</h1>
        <div class='info'>
            <strong>Objetivo:</strong> Adicionar coluna 'estabelecimento_id' na tabela asaas_logs<br>
            <strong>Versão:</strong> 2.0 - Conexão Direta (sem config.php)
        </div>
";

try {
    // Criar conexão PDO direta
    echo "<div class='step'><div class='step-title'>🔌 Passo 1: Conectando ao banco de dados</div>";
    ...
    echo "<div class='success'>✅ Conectado com sucesso ao banco: <code>" . DB_NAME . "</code></div></div>";
    ...
    $testInsert = "INSERT INTO asaas_logs 
                   ...
                   VALUES 
                   ('teste_correcao_v2', 'sucesso', 1, '{}', '{}', 'Teste de correção do banco v2')";
    ...
    echo "<div class='success' style='margin-top: 30px; font-size: 18px;'>
            ...
            A tabela asaas_logs agora possui a coluna 'estabelecimento_id' e está pronta para uso.<br><br>
            <strong>Próximo passo:</strong> Teste o processamento de pagamentos Asaas!
          </div>";
    ...
    echo "<div class='error' style='margin-top: 20px;'>
            ...
            <code>fix_db_asaas_logs_v2.php</code>
          </div>";
...
echo "
        <div class='info' style='margin-top: 30px;'>
            ...
            Database: " . DB_NAME . "<br>
            Host: " . DB_HOST . "<br>
            Script: fix_db_asaas_logs_v2.php
        </div>
    </div>
</body>
</html>";
